  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-primary">Sauces And Pastes</h1>
        ...
        <div className="text-xs sm:text-sm text-muted-foreground">Show 1-20 of 77 products</div>
      </div>
            ...
            <CardContent className="p-2 sm:p-4 flex flex-col h-full">
              ...
              <div className="space-y-1 sm:space-y-2 flex-grow flex flex-col text-center">
                ...
                <div className="flex items-center justify-center">
                  <span className="font-bold text-sm sm:text-lg text-primary">{formatPrice(product.price)}</span>
                </div>
      ...
      <div className="flex items-center justify-center gap-1 sm:gap-2 mt-8">
        ...
        <Button variant="ghost" size="sm" className="w-6 h-6 sm:w-8 sm:h-8 p-0 text-xs sm:text-sm cursor-pointer">
          2
        </Button>
        <Button variant="ghost" size="sm" className="w-6 h-6 sm:w-8 sm:h-8 p-0 text-xs sm:text-sm cursor-pointer">
          3
        ...
        <Button variant="ghost" size="sm" className="text-xs sm:text-sm px-2 sm:px-3 cursor-pointer">
          Next ›
        </Button>
      </div>
    </div>
